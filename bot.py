...
# ------------------------- CONFIG -------------------------
BOT_TOKEN = '8241963079:AAGI3uWQgPobPLb8KvuZ6WFjkTRJj3oW02Y'
ADMIN_ID = '6779617599'
AUTH_FILE = "1.json"
RESULT_FILE = "2.json"
SELLERS_FILE = "3.json"
ADMIN_CONTACT = "tg username"
# ---------------------------------------------------------
...
async def web_server():
    ...
    # ဤနေရာတွင် Port အား 5000 အဖြစ်ပြောင်းလဲသတ်မှတ်ထားပါသည်
...
async def start_polling():
    ...
    # Webhook error မတက်စေရန် အရင်ဖျက်ပေးခြင်း
